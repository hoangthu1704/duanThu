<div class="sma-right">
    <div class="sma-r-top">
        <div class="sma-rt-left">
            <div class="sma-rt-l-title h3">Cập Nhật Sản Phẩm</div>
    ...
    <div class="sma-r-bot">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="prod_name" id="" class="form-control form-lg" placeholder="Nhập Tên Sản Phẩm" value="<?= $show_prod_by_id['TenSanPham'] ?>">
            </div>
            <div class="form-group">
                <?php
                $cat_by_id = getCatelogyById($show_prod_by_id['MaDanhMuc']);
                $subcat_by_id = getSubCatelogyById($show_prod_by_id['SubCategory']);
                ?>
            ...
            <div class="form-group" style="display: none;">
                ...
                <div class="select-input p2-regular-18">
                    <button class="select-input-button" type="button">
                        <span class="select-input-button-value p2-regular-18"><?= $subcat_by_id['TenDanhMuc'] ?></span>
                        <span class="select-input-button-arrow"></span>
                    </button>
                    <ul class="select-input-dropdown">
                        <li>
            ...
            <div class="form-group" style="display: none;">
                ...
                <div class="select-input p2-regular-18">
                    <button class="select-input-button" type="button">
                        <span class="select-input-button-value p2-regular-18"><?= $show_prod_by_id['Unit'] ?></span>
                        <span class="select-input-button-arrow"></span>
                    </button>
                    <ul class="select-input-dropdown">
                        <li>
            ...
            <div class="form-group m-0" style="display: none;">
                ...
                <input type="text" name="prod_minQty" id="" class="form-control form-lg" placeholder="Nhập Số Lượng Nhỏ Nhất" value="<?= $show_prod_by_id['MinQty'] ?>">
            </div>
            <div class="form-group">
                <label for="" class="h6">Số Lượng</label>
                <input type="text" name="prod_qty" id="" class="form-control form-lg" placeholder="Nhập Số Lượng" value="<?= $show_prod_by_id['Qty'] ?>">
            </div>
            <div class="form-group">
                <label for="" class="h6">Giá</label>
                <input type="text" name="prod_price" id="" class="form-control form-lg" placeholder="Nhập Giá" value="<?= $show_prod_by_id['Gia'] ?>">
            </div>
            <div class="form-group" style="display: none;">
                <label for="" class="h6">Thuế</label>
                <div class="select-input p2-regular-18">
                    <button class="select-input-button" type="button">
                        <span class="select-input-button-value p2-regular-18"><?= $show_prod_by_id['thue'] ?></span>
                        <span class="select-input-button-arrow"></span>
                    </button>
                    <ul class="select-input-dropdown">
                        <li>
            ...
            <div class="sma-rb-item form-floating m-0">
                ...
                <textarea name="prod_description" class="form-control" placeholder="Nhập Mô Tả Sản Phẩm" id="floatingTextarea2" style="height: 150px"><?= $show_prod_by_id['MoTa'] ?></textarea>
            </div>
            ...
            <div class="form-group" style="display: none;">
                ...
                <div class="select-input p2-regular-18">
                    <button class="select-input-button" type="button">
                        <span class="select-input-button-value p2-regular-18"><?= $show_prod_by_id['LoaiGiamGia'] ?></span>
                        <span class="select-input-button-arrow"></span>
                    </button>
                    <ul class="select-input-dropdown">
                        <li>
            ...
            <div class="form-group" style="display: none;">
                ...
                <div class="select-input p2-regular-18">
                    <button class="select-input-button" type="button">
                        <span class="select-input-button-value p2-regular-18"><?= $show_prod_by_id['Status'] ?></span>
                        <span class="select-input-button-arrow"></span>
                    </button>
                    <ul class="select-input-dropdown">
                        <li>
            ...
            <div class="form-group">
                ...
                <div class="select-input p2-regular-18">
                    <button class="select-input-button" type="button">
                        <span class="select-input-button-value p2-regular-18"><?= $show_prod_by_id['NoiBat'] === 1 ? "Có" : "Không" ?></span>
                        <span class="select-input-button-arrow"></span>
                    </button>
                    <ul class="select-input-dropdown">
                        <li>
            ...
            <div class="sma-r-end">
                <button type="submit" name="update_product" class="btn btn-primary btn-lg">Cập Nhật Sản Phẩm</button>
