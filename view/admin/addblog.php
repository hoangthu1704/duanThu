<div class="sma-right">
    <div class="sma-r-top">
        <div class="sma-rt-left">
            <div class="sma-rt-l-title h3">Thêm Bài Viết</div>
    ...
    <div class="sma-r-bot">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="blog_title" id="" class="form-control form-lg" placeholder="Nhập Tiêu Đề Bài Viết">
            </div>
            <div class="sma-rb-item form-floating m-0 mt-16">
                ...
                <textarea name="blog_content" class="form-control" placeholder="Nhập Nội Dung Bài Viết" id="floatingTextarea2" style="height: 150px"></textarea>
            </div>
            ...
            <div class="sma-r-end">
                <button type="submit" name="add_blog" class="btn btn-primary btn-lg">Tạo Bài Viết</button>
