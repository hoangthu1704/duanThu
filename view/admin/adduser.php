<div class="sma-right">
    <div class="sma-r-top">
        <div class="sma-rt-left">
            <div class="sma-rt-l-title h3">Thêm Người Dùng</div>
    ...
    <div class="sma-r-bot">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="user_name" id="" class="form-control form-lg" placeholder="Nhập Tài Khoản">
            </div>
            <div class="form-group">
                <label for="" class="h6">Số Điện Thoại</label>
                <input type="tel" name="user_mobile" id="" class="form-control form-lg" placeholder="Nhập Số Điện Thoại">
            </div>
            <div class="form-group">
                <label for="" class="h6">Email</label>
                <input type="email" name="user_email" id="" class="form-control form-lg" placeholder="Nhập Email">
            </div>
            ...
            <div class="form-group mt-16">
                ...
                <input type="password" name="user_password" id="" class="form-control form-lg" placeholder="Nhập Mật Khẩu">
            </div>
            <div class="form-group mt-16">
            ...
            <div class="sma-r-end">
                <button type="submit" name="add_user" class="btn btn-primary btn-lg">Tạo Người Dùng</button>
