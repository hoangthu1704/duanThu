<div class="sma-right">
    <div class="sma-r-top">
        <div class="sma-rt-left">
            <div class="sma-rt-l-title h3">Cập Nhật Danh Mục</div>
        </div>
    </div>
    <div class="sma-r-bot">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="" class="h6">Tên Danh Mục</label>
                <input type="text" name="cat_name" id="" class="form-control form-lg" placeholder="Nhập Tên Danh Mục" value="<?= $show_cat['TenDanhMuc'] ?>">
            </div>
            <div class="sma-rb-item form-floating mt-16">
                <label for="floatingTextarea2" style="position: relative; padding: 0" class="h6">Mô Tả</label>
                <textarea name="cat_description" class="form-control" placeholder="Nhập Mô Tả Danh Mục" id="floatingTextarea2" style="height: 150px"><?= $show_cat['MoTa'] ?></textarea>
            </div>
            <div class="sma-rb-item form-group-img m-0">
                <img src="assets/images/<?= $show_cat['HinhAnh'] ?>" width="100" height="100" alt="">
            ...
            <div class="sma-r-end">
                <button type="submit" name="update_category" class="btn btn-primary btn-lg">Cập Nhật Danh Mục</button>
