<div class="sma-right">
    <div class="sma-r-top">
        <div class="sma-rt-left">
            <div class="sma-rt-l-title h3">Thêm Danh Mục</div>
    ...
    <div class="sma-r-bot">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="cat_name" id="" class="form-control form-lg" placeholder="Nhập Tên Danh Mục">
            </div>
            <div class="sma-rb-item form-floating mt-16">
                ...
                <textarea name="cat_description" class="form-control" placeholder="Nhập Mô Tả Danh Mục" id="floatingTextarea2" style="height: 150px"></textarea>
            </div>
            ...
            <div class="sma-r-end">
                <button type="submit" name="add_category" class="btn btn-primary btn-lg">Tạo Danh Mục</button>
